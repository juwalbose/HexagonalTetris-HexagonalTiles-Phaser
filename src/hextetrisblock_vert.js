...
var game = new Phaser.Game(300, 300, Phaser.AUTO, 'TutContainer', { preload: preload, create: create});
...
function create() {
    bmpText = game.add.bitmapText(10, 10, 'font', 'Block Rotation\nTap Hold to rotate', 18);
    game.stage.backgroundColor = '#cccccc';
    blockData=transpose(blockData);//transpose for having the right shape
    ...
    gameScene=game.add.renderTexture(200,200);
    game.add.sprite(100, 100, gameScene);
